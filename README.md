...
- Automatic Study Table LED
- Smart Fan Speed Control

---

## Smart Automation
- Automatic fan speed adjustment based on room temperature
- Motion-based LED activation
- Distance-based study table lighting
...
| Async Web Server | Fast non-blocking server |
